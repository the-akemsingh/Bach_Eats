...
const Input = ({ value, placeholder, onChange, type,className }: {
    value: string,
    placeholder: string,
    type: string,
    className?: string,
    ...
    return (
        <div className="w-full max-w-xs text-lg bg-gray-100 rounded-lg font-mono">
            ...
            <input
                ...
                className={className || "text-sm custom-input w-full px-4 py-2 border text-black border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:outline-blue-300 hover:shadow-lg hover:border-yellow-700 bg-gray-100 "}
